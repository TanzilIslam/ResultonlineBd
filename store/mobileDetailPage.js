...
export const actions = {
    ...
    FetchMoreRecommendedArticles({ commit, rootState }) {
        return ApiService.GetMoreRecommendedArticles(rootState.mobileDetailPage.PageNumberRecommended).then(response => {
    ...
    FetchMoreHighRatedArticles({ commit, rootState }) {
        return ApiService.GetMoreHighRatedArticles(rootState.mobileDetailPage.PageNumberHighRated).then(response => {
            response.data.results.forEach(element => {
