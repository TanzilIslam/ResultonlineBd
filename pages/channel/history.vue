    ...
    <b-row>
      ...
      <b-col cols="12" sm="12" md="9" lg="9" xl="9">
        ...
        <div v-show="showAboutDiv">
          <h3>this is abour apge of history</h3>
...
export default {
  ...
  head() {
    return {
      title: "history page - ResultOnlineBd",
      meta: [
        {
          hid: "description",
          name: "description",
          content:
            "Here you can find all the latest information about technology and different history cool stuffs.",
        },
      ],
    };
  },
  async fetch() {
    ...
    // Main Tag List Fetch
    await this.$axios
      .$get(process.env.channelMainTag + `history`)
      .then(function (posts) {
